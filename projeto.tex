...
%{
% Parágrafo citando as contribuições de outros trabalhos relacionados
% à busca empírica
%
% Trabalhos a abordar (autotuning):
%
%\begin{itemize}
%    \item OpenTuner
%    \item Atlas
...
%{
% Parágrafo sobre abstrações de alto nível
%}

%{
% Parágrafo sobre trabalhos "teóricos" sobre autotuning.
