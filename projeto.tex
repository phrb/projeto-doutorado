...
nova arquitetura em que se pretenda atingir um desempenho equivalente.
...
Essas estratégias serão implementadas como componenetes dos sistemas PetaBricks
...
Inicialmente, serão exploradas as possibilidades de se utilizar as estratégias
...
otimização baseadas no algoritmo \emph{portfolio}. 
...
\begin{center}
    ...
    \cellcolor{gray!84} Estudo das Possibilidades das Técnicas do AMF  & \cellcolor{gray!16} Estudo do algoritmo \emph{portfolio} no \emph{autotuning online} & \multicolumn{2}{p{6.44cm}|}{\cellcolor{gray!84} Implementação do algoritmo \emph{portfolio} no contexto do \emph{autotuning online} e de problemas de otimização} \\ 
    ...
    \cellcolor{gray!56} Estudo da Implementação do AMF & \cellcolor{gray!56} Busca por novos sistemas de referência & \multicolumn{2}{p{6.44cm}|}{\cellcolor{gray!56} Aplicação de benchmarks e testes de desempenho em diferentes arquiteturas} \\
    \cellcolor{gray!32} Estudo da Implementação do OpenTuner & \cellcolor{gray!70} Estudo do algoritmo \emph{portfolio} no \emph{autotuning} de problemas de otimização & \multicolumn{2}{l|}{} \\ 
    \cellcolor{gray!16} Revisão Bibliográfica &  \cellcolor{gray!84} Submissão de proposta ao BEPE & \multicolumn{2}{l|}{} \\
    \hline
    \end{tabular}
\end{center}
