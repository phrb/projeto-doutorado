...
\begin{center}
    ...
    \begin{minipage}{.4\linewidth}
        \begin{flushleft}
            ...
            \emph{e-mail}: \\pedro.bruel@gmail.com
        \end{flushleft}
    \end{minipage}
    \begin{minipage}{.4\linewidth}
        \begin{flushright}
            \emph{Orientador}: \\Prof. Dr. Alfredo \textsc{Goldman}\\
            \emph{e-mail}: \\gold@ime.usp.br
        \end{flushright}
    \end{minipage}
...
escalonamento da divisão de recursos, assumindo que
...
\subsubsection{Discrete Resource Sharing Scheduling Problem} \label{sec:drssp}
